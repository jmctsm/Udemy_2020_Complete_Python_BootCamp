...
if __name__ == "__main__":
    ...
    while continuePlaying:
        ...
        while already_guessed:
            if dict_letter_options[player_guess] == 0:
                print("You already guessed that letter.  Please try again.")
                player_guess = str(input("Please enter your guess (-1 to exit): "))
                if player_guess == "-1":
                    print("Thank you for playing!!")
                    exit()
            elif dict_letter_options[player_guess] == 1:
                dict_letter_options[player_guess] = 0
